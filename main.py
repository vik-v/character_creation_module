...
def choice_char_class(char_name: str) -> Character:
    ...
    while approve_choice != 'y':
        selected_class = str(input(
                                ...
                                'Лекарь — healer: '))
        if selected_class in character_classes:
            char_class: Character = character_classes[selected_class](char_name)
            print(char_class)
            ...
            print('Такого класса нет. Выбирай с умом.')
    return char_class


def start_training(player: Character) -> None:
    """
    ...
    while cmd != 'skip':
        ...
        if cmd in commands:
            ...
            print('Такой команды нет. Попробуй: \n'
                  '    attack — чтобы атаковать противника, \n'
                  '    defence — чтобы блокировать атаку противника или \n'
                  '    special — чтобы использовать свою суперсилу. \n')
